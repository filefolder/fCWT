...
class Morlet(Wavelet):
    ...
    def value_at(self, a, b):
        return _fcwt.Morlet_value_at(self, a, b)

    def constant(self):
        return _fcwt.Morlet_constant(self)
...
class FCWT(object):
    ...
    def icwt(self, ptransform, scales, preconstructed):
        return _fcwt.FCWT_icwt(self, ptransform, scales, preconstructed)
